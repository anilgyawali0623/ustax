    ...
    <footer className="bg-navy-dark text-white/60 pt-14">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12">
            ...
            <ul className="space-y-2.5 text-sm list-none p-0">
              {[
                ...
                <li key={p}>
                  <Link
                    to={p}
                    className="hover:text-gold transition-colors no-underline text-white/60"
                  >
                    {l}
                  </Link>
                </li>
          ...
          {/* Head Office */}
          <div className="">
            <address className="text-sm not-italic leading-7 text-white/60 inline-block">
              5601 Executive Drive, Suite # 500 Irving, TX, 75038
              <br />
              📞{" "}
              <a
                href="tel:+1 (469) 231-9102"
      ...
      <div className="border-t border-white/10 py-5">
        <p className="text-center text-xs text-white/40">
          © {new Date().getFullYear()} Yoga Tax Solution. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
